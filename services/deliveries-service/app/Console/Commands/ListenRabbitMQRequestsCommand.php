...
class ListenRabbitMQRequestsCommand extends Command
{
    ...
    {
        $this->info("Starting RabbitMQ Request Listener for deliveries-service...");

        try {
            // Initialize the request handler for this service
            $serviceUrl = env("APP_URL", "http://localhost:8006");
            $this->requestHandler = new RabbitMQRequestHandlerService("deliveries", $serviceUrl);
            ...
            $this->info("Listening for requests on queue: deliveries.requests");
