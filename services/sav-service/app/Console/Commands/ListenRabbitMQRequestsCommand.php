...
class ListenRabbitMQRequestsCommand extends Command
{
    ...
    {
        $this->info("Starting RabbitMQ Request Listener for sav-service...");

        try {
            // Initialize the request handler for this service
            $serviceUrl = env("APP_URL", "http://localhost:8008");
            $this->requestHandler = new RabbitMQRequestHandlerService("sav", $serviceUrl);
            ...
            $this->info("Listening for requests on queue: sav.requests");
